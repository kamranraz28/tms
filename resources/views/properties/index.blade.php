            ...
            <tbody>
                @foreach ($properties as $property)
                    <tr>
                        ...
                        <td class="align-middle">{{ $property->name ?? 'N/A' }}</td>
                        <td class="align-middle">{{ $property->position->name ?? 'N/A' }}</td>
                        <td class="align-middle">{{ $property->address ?? 'N/A' }}</td>
