...
<div class="common-container container mt-4 p-4 shadow rounded bg-white">
    ...
    <form action="{{ route('costs.update', $cost->id) }}" method="POST" enctype="multipart/form-data" class="row g-4">
        @csrf
        @method('PUT')
        ...
        <div class="col-12 d-flex justify-content-between">
            ...
            <button type="submit" class="btn btn-success" style="background-color: {{ $buttonColor }};">Update</button>
        </div>
    </form>
</div>
